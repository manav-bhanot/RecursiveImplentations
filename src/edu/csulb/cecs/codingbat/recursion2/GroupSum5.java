 ...
 * @author Manav
 * 
 *         Problem Source : http://codingbat.com/prob/p138907
 * 
 *         Given an array of ints, is it possible to choose a group of some of
 *         the ints, such that the group sums to the given target with these
 ...
 * 
 *         groupSum5(0, [2, 5, 10, 4], 19) → true groupSum5(0, [2, 5, 10, 4],
 *         17) → true groupSum5(0, [2, 5, 10, 4], 12) → false
 *
 */
